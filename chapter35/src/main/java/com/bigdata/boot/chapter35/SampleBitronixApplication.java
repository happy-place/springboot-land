...
import com.bigdata.boot.chapter35.service.AccountService;
...
@Slf4j
public class SampleBitronixApplication implements CommandLineRunner {
	...
	public static void main(String[] args) throws Exception {
		SpringApplication.run(SampleBitronixApplication.class, args).close();
	}
